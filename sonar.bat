dotnet sonarscanner begin /k:"measure_consume_project" /d:sonar.host.url="http://127.0.0.1:9000" /d:sonar.login="sqp_5b3582cc3eff59319d037c4ff74fa9ecf81dd32f" /d:sonar.cs.opencover.reportsPaths=coverage.net6.0.opencover.xml
dotnet build
